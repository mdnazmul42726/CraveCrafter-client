                        ...
                        <div className="flex flex-wrap mb-24 -mx-4">
                            <div className="w-full px-4 mb-8 md:w-1/2 md:mb-0">
                                <div className="sticky top-0 overflow-hidden ">
                                    <div className="relative mb-6 lg:mb-10 lg:h-[600px]">
                                        <img className="object-contain w-full lg:h-full" src={topFoodData.food_img_url} alt="" />
                                    </div>
                                </div>
                            </div>
                            <div className="w-full px-4 md:w-1/2">
                                <div className="lg:pl-20">
                                    <div className="mb-6 ">
                                        <h2 className="max-w-xl mt-6 mb-6 text-xl font-semibold leading-loose tracking-wide  md:text-2xl">{topFoodData.food_name}</h2>
                                    ...
                                    <div className="py-6 mb-6 border-t border-b border-gray-200 dark:border-gray-700">
                                        ...
                                        <span className="text-base text-gray-600 dark:text-gray-400">Category: {topFoodData.food_category}</span> <br />
                                        <span className="text-base text-gray-600 dark:text-gray-400">Added By: N/A</span> <br />
                                        <span className="text-base text-gray-600 dark:text-gray-400">Origin: N/A</span> <br />
                                        <span className="text-base text-gray-600 dark:text-gray-400">Description: N/A</span> <br />
                                    </div>
